...
function executar() {
    ...
    function lop() {
        ...
        if (numero01 == 0 && document.querySelectorAll('.fa-circle')[0].style.color == 'rgb(28, 0, 81)') {
            mainlop01.style.cssText='transform: translate(-97vmin,0); transition: .9s;';
            ...
            mainlop01.style.cssText = 'transform: translate(-195vmin,0); transition: .9s;';
            ...
            mainlop01.style.cssText ='transform: translate(-285vmin,0); transition: .9s;';
            mainlop02.style.cssText ='transform: translate(0vmin,0); transition: 1s;';
            ...
            mainlop02.style.cssText = 'transform: translate(-285vmin,0); transition: 1s;';
            document.querySelectorAll('.fa-circle')[2].style.color = "#ae94df";
            document.querySelectorAll('.fa-circle')[0].style.color = '#1C0051';
            document.querySelectorAll('.fa-circle')[0].style.transition = '1.5s';
            numero01=0;
